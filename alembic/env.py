...
It's configured for async SQLAlchemy 2.0 with our application models.
"""
...
async def run_async_migrations() -> None:
    ...
    This creates an async engine and runs migrations asynchronously.
    """
    ...
    async with connectable.connect() as connection:
        # run_sync: Execute synchronous code in async context
        # Alembic's migration context is synchronous, but we use async engine
